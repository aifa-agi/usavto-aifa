...
import {
  type RequestHints,
  systemPrompt,
} from "@/app/@left/(_sub_domains)/(_CHAT)/(chat)/(_service)/(_libs)/ai/prompts";
import { getTrailingMessageId } from "@/lib/utils";
import { generateTitleFromUserMessage } from "../../../(_service)/(_actions)/actions";
import { createDocument } from "@/app/@left/(_sub_domains)/(_CHAT)/(chat)/(_service)/(_libs)/ai/tools/create-document";
import { updateDocument } from "@/app/@left/(_sub_domains)/(_CHAT)/(chat)/(_service)/(_libs)/ai/tools/update-document";
import { requestSuggestions } from "@/app/@left/(_sub_domains)/(_CHAT)/(chat)/(_service)/(_libs)/ai/tools/request-suggestions";
import { getWeather } from "@/app/@left/(_sub_domains)/(_CHAT)/(chat)/(_service)/(_libs)/ai/tools/get-weather";
import { fileSearchVectorStore } from "@/app/@left/(_sub_domains)/(_CHAT)/(chat)/(_service)/(_libs)/ai/tools/file-search-vector-store";
import { isProductionEnvironment } from "@/app/@left/(_sub_domains)/(_CHAT)/(chat)/(_service)/(_constants)/constants";
import { myProvider } from "@/app/@left/(_sub_domains)/(_CHAT)/(chat)/(_service)/(_libs)/ai/providers";
import { entitlementsByUserType } from "@/app/@left/(_sub_domains)/(_CHAT)/(chat)/(_service)/(_libs)/ai/entitlements";
