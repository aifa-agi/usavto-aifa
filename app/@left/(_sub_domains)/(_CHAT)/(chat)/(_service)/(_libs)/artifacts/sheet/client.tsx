// @/app/@left/(_public)/(_CHAT-FRACTAL)/(chat)/(_service)/(_libs)/artifacts/sheet/client.tsx
...
import { SpreadsheetEditor } from "@/app/@left/(_sub_domains)/(_CHAT)/(chat)/(_service)/(_components)/sheet-editor";
