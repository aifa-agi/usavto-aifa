...
export const contentData = {
  categories: [
  {
    ...
    "pages": [
      {
        "id": "ocwkkjxjlhxq7mie59lgq1pu",
        "title": "Автоматизация путевых листов",
        "linkName": "Автоматизация путевых листов",
        ...
        "order": 1,
        "badgeName": "Путевые листы",
        "description": "знайте, как платформа USAUTO автоматизирует создание и управление путевыми листами для транспортных компаний. Электронные путевые листы, интеграция с медицинскими и техническими проверками, сокращение времени оформления и снижение штрафов. Современное решение для эффективного контроля автопарка.",
        "images": [
          {
            "id": "k1cdfy5sx1jj0k0ogmwrpe4c",
            "alt": "Us Auto",
            "href": "https://9d8adypzz8xutnay.public.blob.vercel-storage.com/usautopro1-qcQiIvPglgYsd6QlYgXRpig8QYqb1v.jpg"
          }
        ],
        "keywords": [
          "цифровая платформа"
      ...
      {
        "id": "y1xiuzj114kgpvqthovqjrr1",
        "title": "Путевые листы онлайн с USAUTO:",
        "linkName": "Путевые листы онлайн с USAUTO:",
        "href": "/putevye-listy/putevye-listy-onlayn-s-usauto",
        "roles": [
          "guest"
        ],
        "hasBadge": false,
...
export const lastUpdated = "2025-09-24T01:22:01.439Z";
