  ...
  categories: [
  {
    ...
    "pages": [
      ...
      },
      {
        ...
        "isReadyDraftForPerplexity": true,
        "updatedAt": "2025-09-26T19:23:46.315Z",
        "isReadyPromptForPerplexity": true,
        "draftContentStructure": [
          {
            "id": "h2-1",
        ...
        "sections": [
          ...
          {
            "id": "h2-5",
            "tempMDXContent": "<h2>Часто задаваемые вопросы об электронном путевом листе USAUTO</h2>\n\n<p>Раздел часто задаваемых вопросов (FAQ) по электронному путевому листу USAUTO создан, чтобы помочь пользователям быстро получить ответы на самые распространённые вопросы. Здесь собрана важная информация, которая позволяет разобраться в нюансах работы с системой, устранить возможные сомнения и повысить эффективность использования электронного путевого листа. Независимо от того, новичок вы или опытный пользователь, в этом разделе вы найдёте полезные разъяснения и рекомендации, которые помогут сэкономить время и избежать типичных ошибок. Такой формат поддержки способствует уверенности в работе с цифровой платформой и улучшает взаимодействие с сервисом, а также снижает нагрузку на службу технической поддержки, предоставляя оперативные и понятные ответы на актуальные вопросы.</p>\n\n<p><strong>Описание изображения:</strong> Сотрудник службы поддержки помогает пользователю, демонстрируя интерфейс электронного путевого листа на экране компьютера.</p>\n\n<h3>Ответы на популярные вопросы об электронном путевом листе USAUTO</h3>\n\n<p>В этом разделе мы рассмотрим наиболее часто возникающие вопросы, связанные с"
          }
        ],
...
export const lastUpdated = "2025-09-26T19:23:54.507Z";
