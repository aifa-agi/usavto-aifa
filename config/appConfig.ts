...
export const appConfig: AppConfig = {
  ...
  // Comments in English: All uploadable images with dynamic file extensions
  images: {
    "ogImage": {
      path: "/app-config-images/og-image.jpg",
      format: "jpeg",
      uploadedAt: "2025-10-06T16:49:46.670Z",
    },"loading-dark": {
    ...
    "homePage-dark": {
      path: "/app-config-images/homepage-dark.svg",
      format: "svg",
      uploadedAt: "2025-10-06T12:00:00.000Z",
    },
    "homePage-light": {
      path: "/app-config-images/homepage-light.svg",
      format: "svg",
      uploadedAt: "2025-10-06T12:00:00.000Z",
    },
    "chatbot-dark": {
      path: "/app-config-images/chatbot-dark.svg",
      format: "svg",
      uploadedAt: "2025-10-06T12:00:00.000Z",
    },
    "chatbot-light": {
      path: "/app-config-images/chatbot-light.svg",
      format: "svg",
      uploadedAt: "2025-10-06T12:00:00.000Z",
    }
  },
...
/**
 * Comments in English: Supported image formats by Next.js Image component
 */
export type ImageFormat = "png" | "jpg" | "jpeg" | "webp" | "avif" | "svg" | "gif";

/**
 * Comments in English: Image types for regular upload endpoint (excluding logo)
 * Logo is handled separately via /api/app-config-upload-with-icons
 */
...
// Last updated: 2025-10-06T16:49:46.673Z
