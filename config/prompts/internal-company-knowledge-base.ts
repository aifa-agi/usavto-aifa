// @/config/prompts/internal-company-knowladge-base.ts


export const INTERNAL_COMPANY_KNOWLEDGE_BASE_TOKENS= 19000
export const INTERNAL_COMPANY_KNOWLEDGE_BASE = `
